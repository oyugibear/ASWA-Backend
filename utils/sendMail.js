...
async function sendWelcomeEmail (email) {
  ...
  async function sendReviewRecievedEmail (email) {
      const transporter = nodemailer.createTransport({
          service: 'gmail',
          host: "smtp.gmail.com",
          port: 587,
      ...
      const info = await transporter.sendMail({
          ...
          text: "Thank you for submiting your review, please await further instructions from the organisers as you continue with the pending submissions.", // plain text body
          // html: "<b>Hello world?</b>", // html body
        });
...
module.exports = {sendWelcomeEmail, sendForgotEmail, sendSubmissionRecievedEmail, sendReviewRecievedEmail}
